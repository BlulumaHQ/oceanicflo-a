...
export function SelectedWorkGallery({ captions, lang }: { captions: readonly string[]; lang: "en" | "zh" }) {
  ...
  return (
    <>
      ...
      <style>{`
        .gallery-grid { display: grid; grid-template-columns: repeat(12, 1fr); gap: clamp(16px, 2.4vw, 32px); }
        ...
        .gallery-media { overflow: hidden; background: var(--of-hairline); position: relative; width: 100%; height: 100%; }
        ...
        .g-4 { grid-column: 5 / span 4; aspect-ratio: 4/5; margin-top: 40px; }
        .g-5 { grid-column: span 4; aspect-ratio: 4/5; }
        .g-6 { grid-column: 3 / span 8; aspect-ratio: 16/9; margin-top: 20px; }
        @media (max-width: 960px) {
          .gallery-grid { grid-template-columns: repeat(6, 1fr); }
          .g-1 { grid-column: span 6; aspect-ratio: 16/10; }
          .g-2 { grid-column: span 6; aspect-ratio: 4/3; }
          .g-3, .g-4, .g-5 { grid-column: span 3; aspect-ratio: 4/5; margin-top: 0; }
          .g-6 { grid-column: span 6; aspect-ratio: 16/9; margin-top: 0; }
        }
        @media (max-width: 560px) {
          .gallery-grid { grid-template-columns: 1fr; }
          .g-1, .g-2, .g-3, .g-4, .g-5, .g-6 { grid-column: span 1; aspect-ratio: 4/3; margin-top: 0; }
        }
      `}</style>
    </>
  );
