...
export function Header({ lang }: { lang: Lang }) {
  ...
  return (
    <>
      ...
      >
        <div className="container-editorial" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 120, paddingBlock: 6 }}>
          <Link to={lang === "en" ? "/" : "/zh"} className="brand-mark" aria-label="Oceanicflo Construction — home">
            <img src="/images/oceanicflo/oceanicflo-logo-header.svg" alt="Oceanicflo Construction" width={340} height={112} />
          </Link>
      ...
      <style>{`
        ...
        .brand-mark img { display: block; height: 108px; width: auto; object-fit: contain; }
        @media (max-width: 560px) { .brand-mark img { height: 80px; } }
